  ...
  return (
    <main className="flex flex-col items-center text-dark dark:text-light w-full min-h-screen p-32 xl:p-24 lg:p-16 md:p-12 sm:p-8 pt-0 md:pt-16">
      <div className="flex items-center justify-center w-full lg:flex-col">
        <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center lg:my-8 lg:order-2">
          <AnimatedText
          ...
          />
          <p
            className="lg:w-[60%] md:w-[80%] my-4 text-md font-medium text-[#4C5456] dark:text-light/75 tracking-wide md:text-sm sm:text-xs"
